...
import com.yt.s_server.home.BorrowedListActivity;
import com.yt.s_server.home.ExamActivity;
import com.yt.s_server.home.HistoryListActivity;
...
public class Home extends Fragment {
    ...
    public void onStart() {
        ...
        Button btnBorrowed = getActivity().findViewById(R.id.btn_borrowed);
        Button btnHistory = getActivity().findViewById(R.id.btn_history);
        ...
        btnBorrowed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), BorrowedListActivity.class);
                startActivity(intent);
            }
        });
    ...
    public void onStop() {
        super.onStop();
        try {
            //TMConnection.getInstance().logout();
        } catch (Exception e){
            e.printStackTrace();
        }
    }
