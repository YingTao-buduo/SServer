    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(){
            ...
            public void run() {
                ...
                try{
                    ...
                    Connection conn_1 = Jsoup.connect(replacePages.get(1));
        ...
        handler = new Handler(){
            ...
            public void handleMessage(Message msg) {
                ...
                for(Element el: trs){
                    ...
                    try{
                        if(Integer.parseInt(bookInfo[0]) > 0){
                            books.add(new Book(tds.get(2).text(), tds.get(1).text(), tds.get(6).text(), tds.get(9).text()));
                        }
                    } catch (Exception e){
                ...
                final ArrayAdapter adapter = new BookAdapter(HistoryListActivity.this, R.layout.view_book, books, false);
